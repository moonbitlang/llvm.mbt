...
void *__llvm_int32_type(void *$0) {
  return LLVMInt32TypeInContext((LLVMContextRef)$0);
}

void *__llvm_context_create() { return LLVMContextCreate(); }

void *__llvm_module_create_with_name_in_context(void *$0,
                                                struct moonbit_string *$1) {
...
void *__llvm_const_int(void *$0, int32_t $1, int32_t $2) {
  return LLVMConstInt((LLVMTypeRef)$0, $1, $2);
}

void *
__llvm_function_type(void *$0,
...
void __llvm_build_ret(void *$0, void *$1) {
  LLVMBuildRet((LLVMBuilderRef)$0, (LLVMValueRef)$1);
}

void __llvm_position_builder_at_end(void *$0, void *$1) {
  LLVMPositionBuilderAtEnd((LLVMBuilderRef)$0, (LLVMBasicBlockRef)$1);
}

void *__llvm_create_builder(void *$0) {
  return LLVMCreateBuilderInContext((LLVMContextRef)$0);
}

void *__llvm_append_basic_block(void *$0, void *$1, struct moonbit_string *$2) {
  char *block_name = convert_moonbit_string_to_c_string($2);
  return LLVMAppendBasicBlockInContext((LLVMContextRef)$0, (LLVMValueRef)$1,
                                       block_name);
}

void __llvm_dump_module(void *$0) { LLVMDumpModule((LLVMModuleRef)$0); }

void *__llvm_add_function(void *$0, struct moonbit_string *$1, void *$2) {
